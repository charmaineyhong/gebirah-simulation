...
- **Dots = Today's Dispatches Only** — animated dots on the flow diagram show goods dispatched from Changi *today*, not cumulative in-transit. This prevents perpetual animation on high-traffic routes.
